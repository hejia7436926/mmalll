...
public class Week1 {
    ...
    public void demo()throws Exception{
        List<KeyValueForDate> list = Week1.getKeyValueForDate("2015-08-23","2016-06-10");
    ...
    public static List<KeyValueForDate> getKeyValueForDate(String startDate,String endDate) throws Exception{
