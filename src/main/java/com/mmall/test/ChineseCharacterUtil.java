...
//        System.out.println(convertHanzi2Pinyin("广州移动",false).toUpperCase());
        String str = "aabbcdergfj";
        String str1 = str.substring(str.length()-2,str.length());
        str = str.substring(0,str.length()-2);//fg
        ...
        String string = sb.append(code).toString();
